...
const COLOR_SCHEMES = {
    light: {
        // ink-400/300 ปรับให้เข้มขึ้นให้ผ่านคอนทราสต์ WCAG (ink-400 ≈ 4.6:1, ink-300 ≈ 3.3:1)
        paper: { 50: '#fdfcfa', 100: '#f6f3ee', 200: '#ece7de', 300: '#ddd6c9' },
        ink: { 900: '#1a1a1a', 700: '#3a3a3a', 500: '#6b6b6b', 400: '#75756f', 300: '#8c8c88', 200: '#c2c2c2' },
        line: '#e8e3d9',
        surface: '#ffffff'
    },
    dark: {
        paper: { 50: '#15151a', 100: '#1c1c22', 200: '#26262e', 300: '#33333d' },
        ink: { 900: '#f2f2f0', 700: '#d4d4d0', 500: '#a8a8a4', 400: '#8f8f8a', 300: '#83837e', 200: '#54544f' },
